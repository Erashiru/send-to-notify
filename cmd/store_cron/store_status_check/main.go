...
func run() error {
	...
	var storeGroupService storeGroupServicePkg.Service
	...
	for _, deliveryService := range application.targets {
		if err = status.CheckStoreStatus(ctx, deliveryService); err != nil {
			return err
		}
	}
