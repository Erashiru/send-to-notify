...
const docTemplate = `{
    ...
    "definitions": {
        ...
        "github_com_kwaaka-team_orders-core_core_externalapi_models.Order": {
            "description": "Discriminator Дискриминатор схемы обьекта. Для MarketplaceOrder равен EatsId Сквозной идентификатор заказа на стороне Яндекс.Еды в формате DDDDDD-DDDDDD",
            "type": "object",
            "properties": {
                "comment": {
                    "type": "string"
        ...
        "github_com_kwaaka-team_orders-core_core_posintegration_resources_http_v1_dto.MenuUploadRequest": {
            ...
            "properties": {
                "menu_url": {
                    "type": "string",
                    "example": "https://kwaaka-menu-files.aws_s3.eu-west-1.amazonaws.com/unit_tests_menu/unit_test_menu_5.json"
                }
            }
        },
